...
public class Wypozyczenie
{
    ...
    public Wypozyczenie(Person osoba, Device sprzet, DateTime dataWypozyczenia, DateTime? terminZwrotu, int kara, DateTime faktycznaDataZwrotu)
    {
        Osoba = osoba;
        Sprzet = sprzet;
        ...
        Kara = kara;
        FaktycznaDataZwrotu =  faktycznaDataZwrotu;
    }
}