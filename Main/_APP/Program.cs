...
Device_parent l4 = new Laptop(GeneratorAjdikow.LastDeviceId(), "HP EliteBook", false, 32, "Intel i7");
...
Device_parent l7 = new Laptop(GeneratorAjdikow.LastDeviceId(), "Microsoft Surface", false, 16, "Intel i5");
...
Device_parent p3 = new Projector(GeneratorAjdikow.LastDeviceId(), "Sony VPL-FHZ55", false, 4000, "3840x2160");
...
Device_parent p6 = new Projector(GeneratorAjdikow.LastDeviceId(), "Panasonic PT-VZ580", false, 4000, "1920x1200");
...
Device_parent m4 = new Mouse(GeneratorAjdikow.LastDeviceId(), "Corsair M65 RGB", false, false, 18000);
...
Device_parent m8 = new Mouse(GeneratorAjdikow.LastDeviceId(), "Genius XScroll", false, true, 800);
