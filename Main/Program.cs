...
Person r1 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Adam", "Małysz",
    EnumPracownikPoziomDostepu.Poziom_Czerwony);
Person r2 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Robert", "Kubica",
    EnumPracownikPoziomDostepu.Poziom_Niebieski);
Person r3 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Justyna", "Kowalczyk",
    EnumPracownikPoziomDostepu.Poziom_Zielony);
Person r4 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Mariusz", "Pudzianowski",
    EnumPracownikPoziomDostepu.Poziom_Czerwony);
Person r5 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Otylia", "Jędrzejczak",
    EnumPracownikPoziomDostepu.Poziom_Niebieski);
Person r6 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Tomasz", "Adamek",
    EnumPracownikPoziomDostepu.Poziom_Zielony);
Person r7 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Kamil", "Stoch",
    EnumPracownikPoziomDostepu.Poziom_Czerwony);
Person r8 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Anita", "Włodarczyk",
    EnumPracownikPoziomDostepu.Poziom_Niebieski);
Person r9 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Paweł", "Fajdek",
    EnumPracownikPoziomDostepu.Poziom_Zielony);
Person r10 = new Pracownik(GeneratorAjdikow.LastPersonId(), "Wojciech", "Nowicki",
    EnumPracownikPoziomDostepu.Poziom_Czerwony);
...
Person s1 = new Student(GeneratorAjdikow.LastPersonId(), "Jan", "Kowalski", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s2 = new Student(GeneratorAjdikow.LastPersonId(), "Anna", "Nowak", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s3 = new Student(GeneratorAjdikow.LastPersonId(), "Piotr", "Wiśniewski", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s4 = new Student(GeneratorAjdikow.LastPersonId(), "Maria", "Wójcik", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s5 = new Student(GeneratorAjdikow.LastPersonId(), "Tomasz", "Kowalczyk", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s6 = new Student(GeneratorAjdikow.LastPersonId(), "Katarzyna", "Kamińska", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s7 = new Student(GeneratorAjdikow.LastPersonId(), "Michał", "Lewandowski", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s8 = new Student(GeneratorAjdikow.LastPersonId(), "Agnieszka", "Zielińska", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s9 = new Student(GeneratorAjdikow.LastPersonId(), "Krzysztof", "Szymański", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
Person s10 = new Student(GeneratorAjdikow.LastPersonId(), "Małgorzata", "Woźniak", EnumTypWypozyczajacego.Student,
    "s" + GeneratorAjdikow.LastIndexNO());
...
Service.PokazSprzetZutylizowany();
Console.WriteLine("\n-- Próba ponowniego usunięcia tego samego sprzętu z listy aktywnych sprzętów");
Service.UsunTrwaleSprzet(p5);
